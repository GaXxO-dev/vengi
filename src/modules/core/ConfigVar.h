...
constexpr const char *VoxformatSaturation = "voxformat_saturation";
constexpr const char *VoxformatHueSteps = "voxformat_huesteps";
constexpr const char *VoxformatSaturationSteps = "voxformat_saturationsteps";
constexpr const char *VoxformatBrightnessSteps = "voxformat_brightnesssteps";
constexpr const char *VoxformatPaletteMatchDistance = "voxformat_palettematchdistance";
constexpr const char *VoxformatTargetColors = "voxformat_targetcolors";
...
constexpr const char *VoxformatNormalize = "voxformat_normalize";
...
constexpr const char *GameModeSprintMultiplier = "g_sprintmultiplier";
